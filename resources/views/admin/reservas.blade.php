                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-4">
                                <div class="w-10 h-10 bg-gray-100 rounded-lg shrink-0"></div> <!-- Placeholder Imagen -->
                                <div>
                                    <h4 class="text-sm font-bold text-[#040116]">Monitor Dell 27'' 4K</h4>
                                    <p class="text-[13px] text-gray-500">TechSolutions GT</p>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex items-center justify-center gap-2">
                                <button class="bg-[#2563eb] hover:bg-blue-700 text-white text-xs font-medium px-4 py-2 rounded-lg transition-colors">Marcar disponible</button>
                                <button class="bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 text-xs font-medium px-4 py-2 rounded-lg transition-colors">Ver producto</button>
                            </div>
                        </td>
                    </tr>
                    <!-- Fila 2 -->
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-4">
                                <div class="w-10 h-10 bg-gray-100 rounded-lg shrink-0"></div> <!-- Placeholder Imagen -->
                                <div>
                                    <h4 class="text-sm font-bold text-[#040116]">Teclado Mecánico Keychron K2</h4>
                                    <p class="text-[13px] text-gray-500">TechSolutions GT</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-600">2026-08-01</td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center gap-1 bg-green-50 border border-green-200 text-green-700 px-3 py-1 rounded-full text-xs font-semibold">
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg> Activada
                            </span>
                        ...
                        <td class="px-6 py-4">
                            <span class="bg-green-50 text-green-600 px-3 py-1 rounded text-xs font-semibold">Notificado</span>
                        </td>
                        <td class="px-6 py-4 text-center">
                            <div class="flex items-center justify-center gap-2">
                                <button class="bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 text-xs font-medium px-4 py-2 rounded-lg transition-colors">Ver producto</button>

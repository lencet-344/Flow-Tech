   ...
   <!-- Sección Beneficios -->
    <div class="max-w-5xl mx-auto px-4 -mt-10 mb-20 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <!-- 3. Estadísticas -->
            <div class="bg-[#8b5cf6] text-white p-6 rounded-2xl shadow-sm border border-[#7c3aed]">
                <svg class="w-8 h-8 text-[#c4b5fd] mb-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
            ...
            <!-- 4. Publicidad -->
            <div class="bg-[#8b5cf6] text-white p-6 rounded-2xl shadow-sm border border-[#7c3aed]">
                <svg class="w-8 h-8 text-yellow-500 mb-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9"/></svg>

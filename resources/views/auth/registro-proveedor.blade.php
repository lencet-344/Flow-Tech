...
<head>
    ...
    <title>Registro de Proveedor / Emprendedor - SINGKI</title>
...
<body class="bg-[#F4F7FF] font-sans text-[#040116] flex min-h-screen flex-col items-center justify-center py-12 px-4">
    ...
    <div class="flex items-center justify-center gap-2 mb-2">
        ...
        <h1 class="text-2xl font-bold">Registro de Proveedor / Emprendedor</h1>
    </div>

    <!-- Subtítulo -->
    <p class="text-gray-600 text-sm mb-6 text-center">Publica tu negocio e inventario</p>
    ...
    <div class="flex items-start justify-between max-w-sm mx-auto mb-10 px-4">
        ...
        <div class="flex flex-col items-center w-32 shrink-0 relative z-10">
            <div id="step-1-circle" class="w-8 h-8 rounded-full bg-[#1F51FF] text-white flex items-center justify-center font-bold text-sm shadow-sm">
                1
            </div>
        ...
        <!-- Paso 2 -->
        <div class="flex flex-col items-center w-32 shrink-0 relative z-10">
            <div id="step-2-circle" class="w-8 h-8 rounded-full bg-gray-200 text-gray-500 flex items-center justify-center font-bold text-sm shadow-sm">
                2
            </div>
            <span class="text-sm text-gray-500 font-semibold mt-2 text-center leading-tight">Datos del negocio</span>
        </div>

    </div>

    <!-- Tarjeta del Formulario -->
    <div class="bg-white rounded-[2rem] p-8 md:p-10 shadow-sm border border-gray-100 max-w-lg w-full relative mt-4">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div id="paso-1">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="email" name="email" placeholder="negocio@correo.com" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#1F51FF] focus:ring-1 focus:ring-[#1F51FF] text-[#1F51FF] font-medium placeholder-[#8FA9FF]" required>

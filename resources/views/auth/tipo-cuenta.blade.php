...
<body class="bg-[#F4F7FF] font-sans antialiased text-[#040116] min-h-screen flex flex-col items-center justify-center py-12 px-4">
    ...
    <div class="max-w-6xl w-full grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
        ...
        <div class="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100 flex flex-col h-full hover:shadow-md transition-shadow">
            ...
            <h2 class="text-xl font-bold mb-3">Soy Cliente</h2>
            ...
            <a href="{{ url('/registro/cliente') }}" class="w-full bg-[#1F51FF] hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-xl transition-colors mt-auto block text-center">Continuar &rarr;</a>
        </div>
        ...
        <div class="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100 flex flex-col h-full hover:shadow-md transition-shadow">
            ...
            <h2 class="text-xl font-bold mb-3">Soy Proveedor / Emprendedor</h2>
            ...
            <a href="{{ url('/registro/proveedor') }}" class="w-full bg-[#1F51FF] hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-xl transition-colors mt-auto block text-center">Continuar &rarr;</a>
        </div>
        ...
        <div class="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100 flex flex-col h-full hover:shadow-md transition-shadow">
            ...
            <h2 class="text-xl font-bold mb-3">Ofrezco Servicios</h2>
            ...
            <a href="{{ url('/registro/servicios') }}" class="w-full bg-[#1F51FF] hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-xl transition-colors mt-auto block text-center">Continuar &rarr;</a>
        </div>

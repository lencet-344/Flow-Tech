                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                                    ...
                                    <td class="px-6 py-4 min-w-[120px] whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end items-center space-x-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <form id="form-delete-{{ $role->id }}" action="{{ route('roles.destroy', $role) }}" method="POST" class="inline-block">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn-delete" onclick="eliminarRegistro(event, this)" title="Eliminar">

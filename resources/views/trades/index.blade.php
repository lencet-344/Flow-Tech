    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700">
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-gray-50/50 dark:bg-gray-900/50 border-b border-gray-100 dark:border-gray-700">
                                ...
                                <th class="px-6 py-4 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Tipo de Producto</th>
                                <th class="px-6 py-4 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Fecha del comercio</th>
                                <th class="px-6 py-4 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Descripcion</th>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            @forelse ($trades as $trade)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                                    <td class="px-6 py-4">
                                        <span class="text-sm font-mono text-gray-400 dark:text-gray-500">{{ $trade->id }}</span>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex justify-end items-center space-x-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <a href="{{ route('trades.edit', $trade) }}" class="text-gray-400 hover:text-amber-500 transition-colors" title="Editar">
                                            ...
                                            <form action="{{ route('trades.destroy', $trade) }}" method="POST" class="inline" id="form-delete-{{ $trade->id }}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" onclick="confirmarEliminacion({{ $trade->id }})" class="text-gray-400 hover:text-red-500 transition-colors" title="Eliminar">
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500 dark:text-gray-400 text-lg font-medium">No hay comercios registrados</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
                ...
                @if(isset($trades) && method_exists($trades, 'hasPages') && $trades->hasPages())
